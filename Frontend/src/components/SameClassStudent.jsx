...
export const SameClassStudent = () => {
    ...
    const editStudent = (student) => {
        navigate("/student-edit", { state: { student, category: "teacher" } });
        // setTimeout(() => {
        //     setTrigger(!trigger);
        // }, 5000)
    }
    ...
    return (
        <div className='class-list same-class mt-40'>
            ...
            <div class="relative overflow-x-auto same-classroom shadow-md sm:rounded-lg student-list">
